...
//        final CompletableFuture<Void> allOfFuture = CompletableFuture.allOf(future1, future2);

        final CompletableFuture<User> combineFuture = future1
                .thenCombine(CompletableFuture.supplyAsync(() -> externalApiClient.getUserInfo(id)), (f1, f2) -> f2);
