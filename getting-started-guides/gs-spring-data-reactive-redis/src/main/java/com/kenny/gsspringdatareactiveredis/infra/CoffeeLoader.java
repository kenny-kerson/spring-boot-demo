package com.kenny.gsspringdatareactiveredis.infra;
...
public class CoffeeLoader {
    ...
    public CoffeeLoader(final ReactiveRedisConnectionFactory factory, final ReactiveRedisOperations<String, Coffee> coffeeOps) {
